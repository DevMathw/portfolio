  ...
  return (
    <section id="top" className="min-h-screen flex flex-col justify-center items-center text-center px-6">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }} className="flex flex-col sm:flex-row gap-4 mt-8">
        ...
        <a href="/cv_mat_en.pdf" download className="px-10 py-3 rounded-full border border-gray-400 hover:bg-green700 hover:text-white hover:border-green700 dark:hover:bg-green400 dark:hover:text-black transition dark:text-white dark:border-white">
          Download CV
        </a>
      </motion.div>
    </section>
